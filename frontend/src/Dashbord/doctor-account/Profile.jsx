...
const Profile = () => {
    ...
    const addExperience = e => {
        ...
        addItem("experiences", {
            startingDate: "", endingDate: "", position: "Senior Surgeon", hospital: "Ruhuna Hospital"
        });
    }
                    ...
                    <div key={index}>
                        ...
                        <div>
                            ...
                            <button
                                ...
                                className='p-2 bg-red-600 p-2 rounded-full text-white text-[18px] mt-2 mb-[30px]'>
                                <AiOutlineDelete />
                            </button>
                        </div>
                    </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                                ...
                                <div className='flex items-center'>
                                    <button
                                        ...
                                        className='p-2 bg-red-600 p-2 rounded-full text-white text-[18px] mt-6'>
                                        <AiOutlineDelete />
                                    </button>
                                </div>
                            </div>
